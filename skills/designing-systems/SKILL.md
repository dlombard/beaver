...
description: Plan, review, or refine the high-level design and architecture of any non-trivial system, product, or platform — software, data/ML/AI, IoT/edge/embedded, or distributed/cyber-physical/hardware. Use whenever someone asks to design, architect, or structure a system, or wants such a design critiqued — including phrasings like "design the system", "architect this", "how should we build X", or "you're the principal/lead engineer", even when the domain sounds like hardware, sensors, or a physical product rather than "software". Produces decision-grade artifacts — product brief, constraint register, architecture, building-block selections, component inventory, data/ML flows, quality attributes, SMART criteria, risks, and a next-phase spec backlog — to prepare a project for detailed specification. Does not write full SRDs, detailed component specs, wireframes, implementation plans, or completion gates.
---
